...
- **Android App Links** — `.well-known/assetlinks.json` needs to be re-added with the `app.kreni` signing fingerprint (confirmed still absent from the repo). See [[0001-mobile-platform-strategy]].
