const hr = {
  translation: {
    ...
    roadClosures: {
      ...
      refreshBadgeRefreshing: 'Osvježavanje…',
      refreshBadgeSeconds: 'Osvježava se za {{count}} s',
      refreshBadgeMinutes: 'Osvježava se za {{count}} min',
      refreshBadgeHours_one: 'Osvježava se za {{count}} sat',
      refreshBadgeHours_few: 'Osvježava se za {{count}} sata',
      refreshBadgeHours_other: 'Osvježava se za {{count}} sati',
    },
    realtimePanel: {
