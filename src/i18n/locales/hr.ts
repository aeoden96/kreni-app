const hr = {
  translation: {
    ...
    updatePrompt: {
      ...
      englishNote: '* Detaljni zapisnici promjena automatski se generiraju iz commitova projekta i dostupni su samo na engleskom jeziku.',
    },
    alertsTab: {
    ...
    onboarding: {
      ...
      navTitle: 'Navigacija',
      navBody: 'Klikni na ikonu u gornjem desnom kutu (Spider izbornik) za brzu promjenu između javnog prijevoza, bicikala, auta i gradskog sadržaja.',
