const hr = {
  translation: {
    ...
    onboarding: {
      ...
      featureTransitListBody: 'Pretraži linije, najbliže stanice, favorite i obavijesti.',
      featureTransitListTitle: 'Javni prijevoz (lista)',
      featureTransitMapBody: 'Vozila uživo + stanice na karti.',
      featureTransitMapTitle: 'Javni prijevoz (karta)',
      githubCta: 'GitHub',
      heroBadge: 'Uživo gradski vodič',
