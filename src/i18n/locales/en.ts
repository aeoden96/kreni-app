const en = {
  translation: {
    ...
    onboarding: {
      ...
      featureTransitListBody: 'Browse routes, nearby stops, favourites, and alerts.',
      featureTransitListTitle: 'Transit (list)',
      featureTransitMapBody: 'Live vehicles + stops on the map.',
      featureTransitMapTitle: 'Transit (map)',
      githubCta: 'GitHub',
