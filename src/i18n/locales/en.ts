const en = {
  translation: {
    ...
    updatePrompt: {
      ...
      englishNote: '* Detailed release notes are automatically generated from project commits and are available in English only.',
    },
    alertsTab: {
    ...
    onboarding: {
      ...
      navTitle: 'Navigation',
      navBody: 'Tap the Spider menu icon in the top right corner to switch between public transport, cycling, driving, and city details.',
