...
const LAYER_KEYS = {
  animal_zones: 'showDomesticAnimalZones',
  bike_parking: 'showBikeParkings',
  bike_paths: 'showBikePaths',
  bike_stations: 'showBikeStations',
  cameras: 'showSurveillanceCameras',
  congestion: 'showCongestionHeatmap',
  cultural: 'showCulturalInstitutions',
  dog_parks: 'showDogParks',
  ev: 'showElectricCharging',
  evacuation: 'showEvacuationAreas',
  fountains: 'showPublicFountains',
  garages: 'showPublicGarages',
  gardens: 'showPublicGardens',
  gas_stations: 'showGasStations',
  health_homes: 'showHealthHomes',
  health_inst: 'showHealthInstitutions',
  markets: 'showMarkets',
  pedestrian: 'showPedestrianZones',
  pharmacies: 'showPharmacies',
  playgrounds: 'showPlaygrounds',
  recycling: 'showRecyclingYards',
  restaurants: 'showStudentRestaurants',
  taxi: 'showTaxiStands',
  toilets: 'showPublicToilets',
